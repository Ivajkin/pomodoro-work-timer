...
@Component({
  selector: 'app-pomodoro-mobile',
  templateUrl: './pomodoro-mobile.component.html',
  styleUrls: ['./pomodoro-mobile.component.scss']
})
export class PomodoroMobileComponent implements OnInit {
